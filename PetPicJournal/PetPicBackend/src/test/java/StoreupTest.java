...
//		StoreupService co = (StoreupService) context.getBean("storeupService");
//		StoreupEntity l = co.selectById(1);
//		
...
//	
	...
	public void test1() {
		ApplicationContext context = new ClassPathXmlApplicationContext("spring/spring.xml");
		StoreupService co = (StoreupService) context.getBean("storeupService");
		StoreupEntity l = co.selectById(31);
