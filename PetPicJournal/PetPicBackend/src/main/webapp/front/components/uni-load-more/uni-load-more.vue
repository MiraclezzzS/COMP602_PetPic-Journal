...
<script>
	...
	/**
	 * LoadMore 加载更多
	 * @description 用于列表中，做滚动加载使用，展示 loading 的各种status
	 * @tutorial https://ext.dcloud.net.cn/plugin?id=29
	 * @property {String} status = [more|loading|noMore] loading 的status
	 * 	@value more loading前
	 * 	@value loading loading中
	 * 	@value noMore There's no more
	 ...
	 * @property {Object} contentText 各status文字说明，值为：{contentdown: "上拉显示更多",contentrefresh: "正在加载...",contentnomore: "没有更多数据了"}
	...
	export default {
		...
		props: {
			status: {
				// 上拉的status：more-loading前；loading-loading中；noMore-There's no more
				type: String,
				default: 'more'
			},
			showIcon: {
