...
<script>
	...
	function oneOf (value, validList) {
		...
		throw new Error('mode invalid，Please select effective mode!');
		return false;
	}
	export default {
		data() {
		...
		props:{
			mode:{
				type:String,
				validator(mode){
					let modeList=['half','date', 'dateTime', 'yearMonth','time','region','selector','limit','limitHour','range','linkage'];//过滤 invalidmode;
