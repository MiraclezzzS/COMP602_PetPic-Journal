	...
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20220730/4b6f6d88fde34446904f3e1cd2807e39.png) center center/cover fixed no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.picture" label="Img" prop="picture">
					<file-upload
						tip="Click to upload images"
						action="file/upload"
						:limit="3"
						:multiple="true"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.picture" label="Img" prop="picture">
	...
	data() {
		...
		return {
			...
			rules: {
				...
				picture: [
					{ required: true, message: 'Img not null', trigger: 'blur' },
				],
				content: [
