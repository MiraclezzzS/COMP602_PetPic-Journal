    ...
    <div v-if="!showFlag" style="width: 100%;">
      <div>
        <el-table
          ...
          style="width: 100%;"
        >
          <el-table-column :resizable='true' :sortable='true' prop="ask" :formatter="askFormat" header-align="center" align="center" sortable label="news"></el-table-column>
          <el-table-column
          ...
          >
            <template slot-scope="scope">
              <el-tag v-if="scope.row.isreply==1" type="success">No response</el-tag>
