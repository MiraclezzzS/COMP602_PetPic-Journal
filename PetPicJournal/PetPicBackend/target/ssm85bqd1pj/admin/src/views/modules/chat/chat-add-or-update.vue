<template>
  <div :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20220730/4b6f6d88fde34446904f3e1cd2807e39.png) center center/cover fixed no-repeat","height":"calc(100vh - 120px)"}'>
    ...
    >
      ...
      <div class="clear-float"></div>
      <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="Reply" prop="reply">
        <el-input v-model="ruleForm.reply" placeholder="Reply" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"100%","padding":"0","margin":"0"}'>
        <el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"30px","background":"#4662A1","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="onSubmit">Reply</el-button>
        <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0","margin":"0","outline":"none","color":"#fff","borderRadius":"30px","background":"#4662A1","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' @click="back()">返回</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  data() {
    return {
      ...
      rules: {
        reply: [
          { required: true, message: "Replycontent not null", trigger: "blur" }
        ]
      },
      inter:null
    };
