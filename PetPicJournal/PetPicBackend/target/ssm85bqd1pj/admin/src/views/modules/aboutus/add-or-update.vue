<template>
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20220730/4b6f6d88fde34446904f3e1cd2807e39.png) center center/cover fixed no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="title" prop="title">
					<el-input v-model="ruleForm.title" placeholder="title" clearable  :readonly="ro.title"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="title" prop="title">
					<el-input v-model="ruleForm.title" placeholder="title" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="subtitle" prop="subtitle">
					<el-input v-model="ruleForm.subtitle" placeholder="subtitle" clearable  :readonly="ro.subtitle"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="subtitle" prop="subtitle">
					<el-input v-model="ruleForm.subtitle" placeholder="subtitle" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.picture1" label="Img1" prop="picture1">
					<file-upload
						tip="点击上传Img1"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.picture1" label="Img1" prop="picture1">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.picture2" label="Img2" prop="picture2">
					<file-upload
						tip="点击上传Img2"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.picture2" label="Img2" prop="picture2">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.picture3" label="Img3" prop="picture3">
					<file-upload
						tip="点击上传Img3"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.picture3" label="Img3" prop="picture3">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="content" prop="content">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.content" label="content" prop="content">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				title: [
					{ required: true, message: 'title not null', trigger: 'blur' },
				],
				subtitle: [
				],
				content: [
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../ssm85bqd1pj/upload');
        } else {
