	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						color: #fff;
						background: url(http://codegen.caihongy.cn/20220730/36510178653143279ad2d006a7f420a1.png) center center/cover no-repeat;
					}
		...
		.el-menu-vertical-demo .el-submenu /deep/ .el-menu .el-menu-item {
						padding: 0 40px;
						color: #A2A2A2;
						background: linear-gradient(90deg, #F9F9F9 0%, #F9F9F9 3%,#4662A1 3%, #4662A1 5%,#F9F9F9 5%,  #F9F9F9 100%);
						border-color: #fff;
		...
		.el-menu-vertical-demo .el-submenu /deep/ .el-menu .el-menu-item:hover {
						padding: 0 40px;
						color: #fff;
						background: linear-gradient(90deg, #4662A1 0%, #4662A1 3%, #F9F9F9 3%, #F9F9F9 5%,#4662A1 5%,  #4662A1 100%);
						line-height: 50px;
						height: 50px;
					}
